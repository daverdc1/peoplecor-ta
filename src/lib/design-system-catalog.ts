...
export const usageCatalog: UsageExample[] = [
  ...
  },
  {
    ...
    description: "Timesheet has not been approved yet.",
    location: "Employee table → Status column",
    file: "employee-approval-pill.tsx",
    viewHint: "Visible on any employee row with a pending timesheet.",
  },
  {
    ...
    location: "Employee table → Status column",
    file: "employee-approval-pill.tsx",
    viewHint: "Approve an employee to see the green Approved pill.",
  },
  {
    id: "badge-stats",
    category: "badge",
