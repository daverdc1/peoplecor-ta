...
export const inspectorRegistry: Record<string, InspectorEntry> = {
  ...
  "PIL-PND": entry("PIL-PND", "Pending / Approve Pill", "src/components/time-attendance/employee-approval-pill.tsx", "TBL-STS"),
  ...
  "DS-BTN-04": instance("DS-BTN", "04", "Payroll Button", "src/components/ui/button.tsx"),
