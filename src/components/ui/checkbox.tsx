...
>(({ className, ...props }, ref) => (
  <CheckboxPrimitive.Root
    ref={ref}
    className={cn(
      "peer relative inline-flex size-4 shrink-0 items-center justify-center rounded-[2px] border border-border-input bg-white transition-colors before:absolute before:-inset-2 before:content-[''] hover:enabled:data-[state=unchecked]:border-subtle group-hover:enabled:data-[state=unchecked]:border-subtle focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand disabled:cursor-not-allowed disabled:opacity-50 data-[state=checked]:border-brand data-[state=checked]:bg-brand data-[state=checked]:text-white data-[state=checked]:hover:enabled:border-brand-dark data-[state=checked]:group-hover:enabled:border-brand-dark data-[state=indeterminate]:border-brand data-[state=indeterminate]:bg-brand data-[state=indeterminate]:text-white data-[state=indeterminate]:hover:enabled:border-brand-dark data-[state=indeterminate]:group-hover:enabled:border-brand-dark",
